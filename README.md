...
Además permite al desarrollador añadir POJOs con metodos marcados como @Web y donde dentro de la anotación se debe colocar el nombre que se desea para que dicho metodo sea accesible de manera web.
